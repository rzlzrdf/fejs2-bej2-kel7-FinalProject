      ...
      <Card className='card__penawaran mx-auto'>
         <Row className='wrapper__ g-0'>
            <Col xl={2} lg={2} md={2} sm={2} className='d-block'>
               <Card.Img src='./Img/jam.svg' alt='' style={{width: 60}} className='d-flex justify-content-center ' />
            </Col>
            <Col lg={10} md={10} sm={10} xs={8} className='wrapper__body__penawaran mx-auto'>
            ...
            <Col sm={12} md={12} lg={12} className='wrapper__button__penawaran'>
              <Button variant={'outline-dark'} className='btn__penawaran2 '>Tolak</Button>
              <Button variant={'dark'} className='btn__penawaran1' onClick={() => setModalShow(true)}>Terima</Button>
            </Col>
            <Col>
              <ModalsTerima
                show={modalShow}
